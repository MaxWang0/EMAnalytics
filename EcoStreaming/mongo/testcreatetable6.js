      ...
      db.newtable2.find().forEach(
          function (table) {
             ...
             var obj = {}
             obj[name] = table.LMP
             db.ercotRTDtable.update({RTS: new Date(table.IntervalEnding),  SP: table.SettlementPoint, SPT: table.SettlementPointType, IRHF: table.IntervalRepeatedHourFlag}, {$set: obj}, {upsert:true})
 });                                                                                            
